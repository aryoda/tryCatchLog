...
#' @param include.timestamp  \code{logical} switch if the timestamp of the caught condition shall be
#'                           included in the output
#' @param use.platform.newline \code{logical}: If \code{TRUE} the line breaks ("newline") will be
#'                             inserted according to the current operation system (Windows: CR+LF,
